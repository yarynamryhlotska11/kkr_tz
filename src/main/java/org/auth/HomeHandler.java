...
public class HomeHandler implements HttpHandler {
    public void handle(HttpExchange t) throws IOException {
        String response = "<!DOCTYPE html><html><head><title>Bootstrap Server</title>" +
                ...
                "a.btn {color: #fff;} a.btn-primary {background-color: #ff1493;} a.btn-secondary {background-color: #555;}" +
                ".contact-info {position: absolute; bottom: 10px; left: 10px;}" +
                "</style></head>" +
                "<body><div class=\"container\"><div class=\"mt-4\">" +
                "<h3>Choose an option</h3><a href=\"/register\" class=\"btn btn-primary mr-2\">Register</a><a href=\"/login\" class=\"btn btn-secondary\">Login</a></div>" +
